...
#### 13. Причина неработоспособности механизма заключается в том, что SELinux блокировал доступ к обновлению файлов на ВМ ns01 для DNS, а также к некоторым файлам, к которым DNS обращается в процессе работы.
